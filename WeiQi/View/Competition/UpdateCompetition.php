...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Competition Detail Update</title>
    ...
    <body>
            ...
            <form id="registerForm">
                <div style="font-size: 20px; font-family: Arial;">
                    ...
                    <input type="submit" value="Update" name="action" class="createStyle" style='background-color: red; margin-left: auto; margin-right: auto; display: block;'/>
                    <br /><br />
                </div>
            </form>
        </div>
